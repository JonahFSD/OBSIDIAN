...
## Process log
- **2026-06-12** — System built fresh on macOS from the reference. macOS adaptations: workspace
  `~/CODE`; vault is the existing Obsidian vault `KB/`; linter is Python 3 (was PowerShell);
  migration records replaced by `PROVENANCE.md`. No growth triggers fired (correctly). See
  `[[2026-06-12 retro]]`.
